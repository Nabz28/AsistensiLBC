    ...
    notes: [
      {
        ...
        cards: [
          { title: { en: 'The state corrects market failure', id: 'Negara mengoreksi kegagalan pasar' },
            html: '<p>The market mechanism does <b>not always</b> deliver an efficient allocation (Stiglitz & Rosengard). Under <span class="key">cateris paribus</span> failures the government steps in to:</p>' +
          ...
          { title: { en: 'Keynesian turn: the government must manage cycles', id: 'Pergeseran Keynesian' },
            html: '<p>Before the Great Depression, neoclassical economics assumed the market is <b>self-correcting</b> (Marshall). The 1929–39 Depression showed prolonged mass unemployment and disequilibrium — the market did <i>not</i> self-correct.</p>' +
      ...
      },
      {
        ...
        cards: [
          { title: { en: 'Allocation · Distribution · Stabilization', id: 'Alokasi · Distribusi · Stabilisasi' },
            html: '<p>Fiscal policy directs the economy through <b>revenue, spending and financing</b>. Musgrave’s three functions:</p>' +
          ...
          { title: { en: 'APBN and GDP: the G in Y = C + I + G + (X−M)', id: 'APBN dan PDB' },
            html: '<p>Government consumption <b>G</b> is a direct component of GDP. Beyond G, the budget also shapes <b>C</b> (transfers, subsidies → household consumption) and <b>I</b> (capital spending, investment financing → gross fixed capital formation, PMTB).</p>' +
      ...
      },
      {
        ...
        cards: [
          { title: { en: 'The APBN cycle: year T starts in year T−1', id: 'Siklus APBN' },
            html: '<p>APBN is a <b>political product</b>: proposed by the Government, approved by Parliament (DPR). The cycle for year T begins in T−1:</p>' +
          ...
          { title: { en: 'I-account, GFS and the audit opinion', id: 'I-account, GFS & opini audit' },
            html: '<p>Since 2001 the APBN uses an <b>I-account</b> (unified budget; FY = Jan 1–Dec 31), after the 2003–04 state-finance reforms (UU 17/2003, 1/2004, 15/2004) and adoption of IMF <span class="key">GFS</span>. Year-end reporting = <span class="key">LKPP</span>, audited by <b>BPK</b>.</p>' +
      ...
      },
      {
        ...
        cards: [
          { title: { en: 'What a fiscal rule is', id: 'Apa itu aturan fiskal' },
            html: '<p>A <span class="key">fiscal rule</span> is a long-lasting constraint on fiscal policy through numerical limits on budget aggregates — it contains the pressure to overspend in good times and protects debt sustainability. Four types:</p>' +
    ...
    formulas: [
      { cards: [
        { title: { en: 'GDP expenditure identity', id: 'Identitas pengeluaran PDB' },
          html: '<div class="formula">$$ Y = C + I + G + (X - M) $$</div><p>Fiscal policy moves <b>G</b> directly and <b>C, I</b> indirectly (transfers, subsidies, capital spending).</p>' },
        { title: { en: 'Primary balance', id: 'Keseimbangan primer' },
          html: '<div class="formula">$$ \\text{Primary balance} = \\text{Revenue} - (\\text{Expenditure} - \\text{interest}) $$</div>' +
        ...
        { title: { en: 'Fiscal-rule ceilings (UU 17/2003)', id: 'Plafon aturan fiskal' },
          html: '<div class="formula">$$ \\frac{\\text{Deficit}}{\\text{GDP}} \\le 3\\%, \\qquad \\frac{\\text{Debt}}{\\text{GDP}} \\le 60\\% $$</div>' },
        { title: { en: 'Debt dynamics (r − g rule)', id: 'Dinamika utang (aturan r − g)' },
          html: '<div class="formula">$$ d_{t+1} = d_t\\,\\frac{1+r}{1+g} - pb $$</div>' +
    ...
    graphs: [
      { cards: [
        { title: { en: 'Debt sustainability: the r − g rule', id: 'Keberlanjutan utang: aturan r − g' },
          html: '<p>Move the interest rate, growth, primary balance and starting debt. When growth beats the interest rate the debt ratio settles down; when <b>r > g</b> it drifts up through the 60% rule unless you run a surplus. This is the engine behind every "is the debt sustainable?" exam question.</p>',
